...
/**
 * Created by Nayan on 21/02/2017.
 */
public class CalendarInstance {
    ...
    public int getCalendarDay() {
        if (mMode == MyCalendarView.Mode.Hijri.getModeValue())
            return hijri.getCalendarDay() - MyCalendarView.adjustment;
//            return hijri.getCalendarDay();
    ...
    public static class HijriCalendar {
        ...
        public HijriCalendar(Context context) {
            ...
            countYear = calendar.get(Calendar.YEAR);
            currentMonth = countMonth;
            Log.e(TAG, "HijriCalendar: " + (calendar.get(Calendar.DAY_OF_MONTH)));
            currentYear = countYear;
...
//        }
        ...
        public void plusMonth() {
            ...
            calendar = new MyCustomCalendar(countYear, countMonth, calendar.get(Calendar.DAY_OF_MONTH) - 2);
        }
        ...
        public int getWeekStartFrom() {
            ...
            temp.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), 1 + MyCalendarView.adjustment);
            return temp.get(Calendar.DAY_OF_WEEK);
        }
